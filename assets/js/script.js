...
var Default = {
    alwaysOpen: false,
    activeClasses: 'bg-transparent text-[#4D71FF]',
    inactiveClasses: 'bg-transparent text-[#222E3A] dark:text-gray-400',
...
var tabs_Default = {
    defaultTabId: null,
    activeClasses: 'text-[#ffffff] hover:text-[#ffffff]',
    inactiveClasses: 'text-[#ffffff] hover:text-[#ffffff]',
            ...
            if (this._items.length) {
                ...
                this._items.map(function (tab) {
                    tab.triggerEl.addEventListener('click', function () {
                        ...
                        $('.2-card-slider').slick('refresh');
                        $('.4-card-slider').slick('refresh');
                    });
                });
            }
        }
...
function drawer_toConsumableArray(arr) {
    return drawer_arrayWithoutHoles(arr) || drawer_iterableToArray(arr) || drawer_unsupportedIterableToArray(arr) ||
...
function drawer_unsupportedIterableToArray(o, minLen) {
    ...
    if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return drawer_arrayLikeToArray(o,
        minLen);
}

function drawer_iterableToArray(iter) {
    if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(
        iter);
}
...
function drawer_objectSpread(target) {
    for (var i = 1; i < arguments.length; i++) {
        ...
        i % 2 ? drawer_ownKeys(Object(source), !0).forEach(function (key) {
            ...
            source)) : drawer_ownKeys(Object(source)).forEach(function (key) {
    ...
    drawer_createClass(Drawer, [{
        ...
        value: function hide() {
            ...
            if (this._options.edge) {
                this._getPlacementClasses(this._options.placement + '-edge').active.map(function (
                    c) {
                    _this2._targetEl.classList.remove(c);
                });

                this._getPlacementClasses(this._options.placement + '-edge').inactive.map(function (
                    c) {
        ...
        value: function _createBackdrop() {
            ...
            if (!this._visible) {
                ...
                (_backdropEl$classList = backdropEl.classList).add.apply(_backdropEl$classList,
    ...
    document.querySelectorAll('[data-drawer-target]').forEach(function (triggerEl) {
        ...
        if (getDrawerInstance(drawerId, drawerInstances)) {
            ...
            drawer = new Drawer(targetEl, {
                ...
                bodyScrolling: bodyScrolling ? bodyScrolling === 'true' ? true : false : drawer_Default
                    .bodyScrolling,
